...
public static class SettingsRegistry
{
    private const string DefaultsJson = """
    {
      ...
      "usenet.providers":"","usenet.max-download-connections":"15","usenet.max-queue-connections":"","usenet.warm-validation-concurrency":"",
        ...
        new Dictionary<string, (long Min, long Max)>
    {
        ...
        ["usenet.warm-validation-concurrency"] = (1, 512),
        ["usenet.ready-connections.primary"] = (0, 512),
        ["usenet.ready-connections.health"] = (0, 512),
